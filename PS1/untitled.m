...
% Weighted Variance (More accurate population variance)
weighted_variance = sum(pdf_z .* (income_vector - mean_income).^2);
std_dev_income_pop = sqrt(weighted_variance);

% Coefficient of Variation
std_mean_ratio = std_dev_income_pop / mean_income;
